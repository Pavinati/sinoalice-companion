...
const AboutPage = () => (
  <Box>
    ...
    <h4>Credits</h4>
    <p>Thanks to <a href="sinoalice.game-db.tw" target="_blank" rel="noreferrer">sinoalice db</a> for the weapon images and stats.</p>
    <p>A big thanks to Blue#7239 and the crew at #en-sino-number-crunching for the precious feedback and spreadsheets formulae.</p>
  </Box>
);
